...
public interface IMatriculaService {
   ...
   */
  Matricula create(MatriculaForm form) throws ExceptionMatriculaNaoEncontrado;
  ...
  Matricula getAllMatriculaId(Long id) throws ExceptionMatriculaNaoEncontrado;
  /**
   * Deleta uma Matrícula específica.
   * @param id - id da Matrícula que será removida.
   */
  void delete(Long id) throws ExceptionMatriculaNaoEncontrado;
