...
public interface IAlunoService {
   ...
   */
  Aluno update(Long id, AlunoUpdateForm formUpdate) throws ExceptionAlunoNaoEncontrado;

  /**
   * Deleta um Aluno específico.
   * @param id - id do Aluno que será removido.
   */
  void delete(Long id) throws ExceptionAlunoNaoEncontrado;

  List<AvaliacaoFisica> getAllAvaliacaoFisicaId(Long id) throws ExceptionAlunoNaoEncontrado;
}
