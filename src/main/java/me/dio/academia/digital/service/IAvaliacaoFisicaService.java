...
public interface IAvaliacaoFisicaService {
   ...
   */
  AvaliacaoFisica create(AvaliacaoFisicaForm form) throws ExceptionAvaliacaoFisicaNaoEncontrado;
   ...
   */
  AvaliacaoFisica update(Long id, AvaliacaoFisicaUpdateForm formUpdate) throws ExceptionAvaliacaoFisicaNaoEncontrado;

  /**
   * Deleta uma Avaliação Física específica.
   * @param id - id da Avaliação Física que será removida.
   */
  void delete(Long id) throws ExceptionAvaliacaoFisicaNaoEncontrado;
}
